...
-(void)setNormalBackgroundImageName:(NSString*)name{
    [self setBackgroundImage:YSNameImage(name) forState:UIControlStateNormal];
}
...
-(void)setHighlightedBackgroundImageName:(NSString*)name{
    [self setBackgroundImage:YSNameImage(name) forState:UIControlStateHighlighted];
}
...
-(void)setSelectedBackgroundImageName:(NSString*)name{
    [self setBackgroundImage:YSNameImage(name) forState:UIControlStateSelected];
}
